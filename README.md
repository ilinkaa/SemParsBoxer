...
Kamp, H., Reyle, U., & Genabith, J. van. (2024). Discourse representation theory. In E. N. Zalta & U. Nodelman (Eds.), Stanford Encyclopedia of Philosophy (Spring 2024 ed.). Stanford University. https://plato.stanford.edu/entries/discourse-representation-theory/# SemParsBoxer
A rudimentary Boxer-inspired semantic parser in Python. 
